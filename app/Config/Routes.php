...
$routes->group('admin/slider', function ($routes) {
...
$routes->group('admin/mobil', function ($routes) {
...
$routes->group('admin/type', function ($routes) {
...
$routes->group('admin/information', function ($routes) {
...
$routes->group('admin/berita', function ($routes) {
...
$routes->group('admin/article', function ($routes) {
