...
<div>
    <form action="/admin/article/save" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
        <?= csrf_field() ?>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control <?= $validation->hasError('isi') ? 'is-invalid' : '' ?>" id="isi" name="isi">
            <div class="invalid-feedback">
